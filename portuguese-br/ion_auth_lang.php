...
/**
* Name:  Ion Auth Lang - Portuguese BR
*
* Author: Ben Edmunds
...
* Created:  03.14.2010
*
* Description:  Portuguese BR language file for Ion Auth messages and errors
*
*/

// Account Creation
$lang['account_creation_successful'] 	  	 = 'Conta criada com sucesso';
$lang['account_creation_unsuccessful'] 	 	 = 'Não é possível criar conta';
$lang['account_creation_duplicate_email'] 	 = 'E-mail já utilizado ou inválido';
$lang['account_creation_duplicate_username'] = 'Nome de usuário já utilizados ou inválido';
$lang['account_creation_missing_default_group'] = 'O grupo padrão não está definido';
$lang['account_creation_invalid_default_group'] = 'Conjunto de nome de grupo padrão inválido';
...
$lang['forgot_password_successful'] 	 	 = 'Redefinição de senha E-mail enviado';
$lang['forgot_password_unsuccessful'] 	 	 = 'Não é possível redefinir a senha';

// Activation
$lang['activate_successful'] 		  	     = 'Conta ativada';
$lang['activate_unsuccessful'] 		 	     = 'Não é possível ativar a conta';
$lang['deactivate_successful'] 		  	     = 'Conta ativada';
$lang['deactivate_unsuccessful'] 	  	     = 'Não é possível desativar conta';
$lang['activation_email_successful'] 	  	 = 'E-mail de ativação enviada';
...
$lang['login_timeout']                       = 'Temporariamente bloqueada.  Tente novamente mais tarde.';
...
$lang['group_already_exists']       = 'Nome do grupo em uso';
$lang['group_update_successful']    = 'Detalhes de grupo atualizados';
$lang['group_delete_successful']    = 'Grupo excluído';
$lang['group_delete_unsuccessful'] 	= 'Não é possível excluir o grupo';
